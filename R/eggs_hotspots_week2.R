...
eggs_hotspots_week2 <- function(path_lect, year = NULL, locality, cve_ent,
                               leg_title, fam, alpha, plot = NULL,
                               aproximation, integration,
                               k, sem,
                               palette_vir, hist_dataset){
    ...
    index <- INLA::inla.stack.index(stack = stack_full,
                                    tag = "pred")$data

...
#| echo: true
#| output: false
path_ovitraps <- "/Users/fdzul/Dropbox/CENAPRECE/2024/27_tabasco"
...
Código 
```{r, warning=FALSE, message=FALSE, out.width = '100%', out.height= '100%', dpi=300}
# Step 1. define the path ####
...
library(sf)
library(INLA)
# # Step 2. run the spde model of Merida ####
merida <- deneggs::eggs_hotspots_week(cve_mpo = "050",
                                           cve_edo = "31",
                                           year = "2024",
                                           hist_dataset = FALSE,
...
Mapa de Intensidad
```{r,warning=FALSE, message=FALSE, out.width = '100%', out.height= '100%', dpi=300}
deneggs::map_eggs_hotspots(betas = merida$betas,
                           locality = c("Merida", "Uman", 
                                        "Kanasin", "Caucel"),
                           cve_edo = "31",
